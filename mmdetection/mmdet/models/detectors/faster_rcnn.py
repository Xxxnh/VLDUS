...
class FasterRCNN(TwoStageDetector):
    ...
    def feats_extract(self,
        ...
        # gt_to_select = fg_inds[:gt_num]
        # sub_neg_inds_with_gt = np.random.permutation(bg_inds)[:int(2*len(gt_to_select))]
        # gt_all_to_select = np.concatenate((sub_neg_inds_with_gt, gt_to_select))

        #return bbox_feats[gt_all_to_select], bbox_targets[0][gt_all_to_select], bbox_targets[2][gt_all_to_select]
