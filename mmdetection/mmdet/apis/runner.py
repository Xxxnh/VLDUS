...
def copy_synthesised_weights(model, filename, dataset_name='voc', split='65_15'):
    ...
    # own_state['bbox_head.fc_cls.bias'][unseen_class_inds] = state_dict['fc1.bias'][1:].to(device)
    # own_state['bbox_head.fc_cls.weight'][unseen_class_inds] = state_dict['fc1.weight'][1:].to(device)
    ...
    # own_state['bbox_head.fc_cls.weight'][0] = alpha1*own_state['bbox_head.fc_cls.weight'][0] + alpha2*state_dict['fc1.weight'][0].to(device)
...
#     own_state['bbox_head.fc_cls.bias'] = own_state['bbox_head.fc_cls.bias'].to(device)
#     own_state['bbox_head.fc_cls.weight'] = own_state['bbox_head.fc_cls.weight'].to(device)
#     state_dict['fc1.bias'] = state_dict['fc1.bias'].to(device)
#     state_dict['fc1.weight'] = state_dict['fc1.weight'].to(device)
