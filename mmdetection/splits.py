...
DIOR_ALL_CLASSES = np.array([
                'Expressway-Service-area', 'Expressway-toll-station','airplane', 'airport', 'baseballfield', 'basketballcourt', 
                'bridge', 'chimney', 'dam', 'golffield', 'groundtrackfield', 'harbor',
...
DIOR_UNSEEN_CLASSES = np.array(['airport', 'basketballcourt', 'groundtrackfield', 'windmill'])
